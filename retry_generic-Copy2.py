...
fig.write_image("results/exp2/resid_pre_activation_patching1.png")
...
fig.write_image("results/exp2/attn_head_out Activation Patching All Pos1.png")
...
if DO_SLOW_RUNS:
    ...
    fig = imshow(attn_head_out_act_patch_results, 
        ...
        return_fig=True)
    fig.write_image("results/exp2/attn_head_out_act_patch_results1.png")
...
# Save the figure
fig.write_image("results/exp2/attn_head_out_act_patch_results_sliced1.png")
...
output_path = f"results/exp2/converted_tuples1.json"
...
def save_relevant_attention_patterns(clean_cache, layer_head_tuples):
    for layer_ind, head_ind in layer_head_tuples:
        ...
        # Display the figure
        fig.write_image(f"results/exp2/heads/L{layer_ind}H{head_ind}_atten_pattern1.png")
