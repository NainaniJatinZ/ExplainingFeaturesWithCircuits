...
fig.write_image("results/exp4/resid_pre_activation_patching4.png")
...
fig.write_image("results/exp4/attn_head_out Activation Patching All Pos4.png")
...
if DO_SLOW_RUNS:
    ...
    fig = imshow(attn_head_out_act_patch_results, 
        ...
        return_fig=True)
    fig.write_image("results/exp4/attn_head_out_act_patch_results4.png")
...
# Save the figure
fig.write_image("results/exp4/attn_head_out_act_patch_results_sliced4.png")
...
output_path = f"results/exp4/converted_tuples4.json"
...
def save_relevant_attention_patterns(clean_cache, layer_head_tuples):
    for layer_ind, head_ind in layer_head_tuples:
        ...
        # Display the figure
        fig.write_image(f"results/exp4/heads/L{layer_ind}H{head_ind}_atten_pattern4.png")
